...
// drs: NumSGridCellsLarge
#include "experiment/SGrid/NumSGridCellsLarge.h"
#include "experiment/SGrid/SGridBucketSizeLarge.h"
...
#include "experiment/Fish/ScaleFish.h"
#include "experiment/Fish/ScaleInformed.h"
...
Experiment2D* getExperimentByName(const char* name) {
  ...
  // drs: SGrid
  else if (strcmp(name, "NumSGridCellsLarge") == 0) {
    return new NumSGridCellsLarge();
  } else if (strcmp(name, "SGridBucketSizeLarge") == 0) {
    return new SGridBucketSizeLarge();
  }
  // drs: SGrid
    ...
    return new VXMax();
  } else if (strcmp(name, "ScaleInformed") == 0) {
    return new ScaleInformed();
  } else if (strcmp(name, "ScaleFish") == 0) {
    return new ScaleFish();
  } else {
